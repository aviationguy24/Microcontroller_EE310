 ...
 * ---------------------
 * Program Details:
 *  The purpose of this program is to interfacing the PIC with a variable voltage divider and a 16x2 LCD.
 * Inputs: RA0 (Analog Input) 
 * Outputs: RD1-D2, and RB0- RB7 outputs for the LCD
 * Date: Apr 30, 2024
