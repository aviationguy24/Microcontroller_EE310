...
#include <xc.inc> 
//PROGRAM INPUTS
#define  measuredTempInput 	47 ; this is the input value from the Temp Sensor
#define  refTempInput 		0 ; this is the input value from the Keypad
...
RMND_L	EQU  0x60   ;First Digit
RMND_M	EQU 0X61    ;Second Digit
RMND_H	EQU 0X62    ;Third Digit
...
NUME	EQU 0x43 ;RAM Location for NUME
QU	EQU 0x10    ;RAM Location for Quotient
REF_RMND_L	EQU  0x70   ;First Digit
REF_RMND_M	EQU 0X71    ;Second Digits
REF_RMND_H	EQU 0X72    ;Third Digit
